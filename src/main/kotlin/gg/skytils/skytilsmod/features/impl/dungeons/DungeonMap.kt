...
object DungeonMap {
    ...
    class TrashDungeonMap : GuiElement(name = "Dungeon Map", x = 0, y = 0) {
        ...
        private fun readMapData() {
            for (slot in 0 until mc.thePlayer.inventory.mainInventory.size) {
                val mapItem = mc.thePlayer.inventory.getStackInSlot(slot)
                if (mapItem != null && mapItem.item is ItemMap) {
