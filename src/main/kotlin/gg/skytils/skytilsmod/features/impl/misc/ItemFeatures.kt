...
object ItemFeatures {
    ...
    fun onRenderWorld(event: RenderWorldLastEvent) {
        ...
        if (Skytils.config.showEtherwarpTeleportPos && mc.thePlayer?.isSneaking == true) {
            ...
            val itemName = heldItem.displayName  // Get the formatted text of the item name

            // Check if the item name contains either "Aspect of the Void" or "gyrokinetic wand"
            if (!itemName.contains("Aspect of the Void") && !itemName.contains("Gyrokinetic Wand")) return
