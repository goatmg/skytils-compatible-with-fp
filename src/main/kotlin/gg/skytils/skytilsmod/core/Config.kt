...
object Config : Vigilant(
    ...
    @Property(
        type = PropertyType.SWITCH, name = "Box Wither Doors",
        description = "i made this my self @goatmg",
    ...
    @Property(
        type = PropertyType.SWITCH, name = "Show Etherwarp and Gyro Position",
        description = "Shows the block you will teleport to with the Etherwarp Transmission ability and Gyro position while sneaking.",
        category = "Miscellaneous", subcategory = "Items"
    )
    ...
    @Property(
        type = PropertyType.SWITCH, name = "Hide 0 hp nametags",
        description = "Removes dead/dying mob's nametag from your screen.",
        category = "Miscellaneous", subcategory = "Quality of Life"
    )
    var hide0hpMobs = false
